...
const UserEmailVerification = ({ link, fname }) => {
  return (
    <div
      style={{
        maxWidth: "700px",
    ...
    >
      <div>
        <header
          style={{
            backgroundColor: "#4c8bf5", // Updated header background color
            padding: "20px",
            borderRadius: "5px",
            textAlign: "center",
          }}
      ...
      <p style={{ fontSize: "14px"}}>
        Thank you for signing up with tasky.app! Please click the button below
